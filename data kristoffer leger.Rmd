...
x_train <- vectorize_sequences(train_data_multi)
x_test <- vectorize_sequences(test_data_multi)
```
...
Ved ham overfitter den efter 9, så han prøver med en ny:
